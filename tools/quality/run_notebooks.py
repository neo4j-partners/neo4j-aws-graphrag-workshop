...
Usage:
    ...
    uv run python ../tools/quality/run_notebooks.py
    uv run python ../tools/quality/run_notebooks.py --modules 1
    uv run python ../tools/quality/run_notebooks.py --modules 1-3
    uv run python ../tools/quality/run_notebooks.py --modules 4,5 --include-deploy
    uv run python ../tools/quality/run_notebooks.py --list
"""
...
OUTPUT_ROOT = REPO_ROOT / "workfolder" / "notebook-output"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--keep-output",
        action="store_true",
        help="Keep executed copies under workfolder/notebook-output/.",
    )
    parser.add_argument(
        "--list",
        action="store_true",
