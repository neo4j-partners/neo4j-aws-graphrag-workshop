...
Used for: maintainer smoke testing after notebook or shared-code changes.
...
Usage:
    ...
    uv run python ../workfolder/maintenance/quality/run_notebooks.py
    uv run python ../workfolder/maintenance/quality/run_notebooks.py --modules 1
    uv run python ../workfolder/maintenance/quality/run_notebooks.py --modules 1-3
    uv run python ../workfolder/maintenance/quality/run_notebooks.py --modules 4,5 --include-deploy
    uv run python ../workfolder/maintenance/quality/run_notebooks.py --list
"""
...
OUTPUT_ROOT = REPO_ROOT / "workfolder" / "maintenance" / "notebook-output"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--keep-output",
        action="store_true",
        help="Keep executed copies under workfolder/maintenance/notebook-output/.",
    )
    parser.add_argument(
        "--list",
        action="store_true",
