...
CRITICAL_FILES = {
    ...
    "build_script": Path("workfolder/maintenance/release/build_prebuilt_graph.sh"),
    "manifest_writer": Path("workfolder/maintenance/release/write_prebuilt_manifest.py"),
}
